...
const AppMenuItemMobile: FC<AppMenuItemProps> = memo((props) => {
  const { name, link, Icon, items = [], isActive } = props;
    ...
    <Collapse in={open} timeout="auto" unmountOnExit>
      <List component="div" disablePadding>
        {items.map((item, index) => (
          <AppMenuItemMobile {...item} key={index} />
        ))}
      </List>
    </Collapse>
  ) : null;
...
export default memo(AppMenuItemMobile);
